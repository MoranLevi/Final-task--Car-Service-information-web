...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            const response = await fetch('https://car-service-information-web-server.vercel.app/getCarsData'); /* send request to the server */
    ...
    const onClickDelete = async (row) => {
        ...
        await fetch('https://car-service-information-web-server.vercel.app/deleteCar', {
            method: 'POST',
